...
![*One of the few places to maintain a safe distance from other pedestrians, Colonial Lake is closed during the Shelter-in-Place.*](/post/2020-04-18-impossible-distancing-on-charleston-sidewalks_files/colonial_lake.PNG)
...
I have some concerns about the data itself, as it is comprised of several older data sources.  When I calculated the width of the sidewalk in front of my house using the Edge of Pavement data, I got 2.5 ft, but when I measured the width with a tape measure, it was 5 ft across.  I recorded similar numbers in front of my parents' house.  So, I created a sidewalk width metric and then, unscientifically, **doubled** it for every piece of sidewalk.  I wanted to give that data the benefit of the doubt. *Update: During a quarantine walk, I spot-checked several other sections of sidewalk in my neighborhood and found the City data fairly inaccurate - doubling the widths as above brings the data in closer approximation of the real sidewalk widths.*

I am not familiar enough with all city neighborhoods to know how accurate the data is regarding the shape width.  I did notice, for example, that South Windemere does not even have sidewalks in the traditional sense.  Driveways seem to be marked as the only sidewalks in the neighborhood, not even offering pedestrians a continuous safe place to walk from vehicular traffic.
...
Lastly, if you look closely at each neighborhood, you can see the sidewalk bits, colored by their width.  
