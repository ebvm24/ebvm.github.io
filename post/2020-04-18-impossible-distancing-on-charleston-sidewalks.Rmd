...
I have some concerns about the Edge of Pavement dataset, as it is comprised of several older data sources.  When I calculated the width of the sidewalk in front of my house using the Edge of Pavement data, I got 2.5 ft, but when I measured the width with a tape measure, it was 5 ft across.  I recorded similar numbers in front of my parents' house.  So, I created a sidewalk width metric and then, unscientifically, **doubled** it for every piece of sidewalk.  **All figures represented in maps reflect this doubling.**  I wanted to give this data the benefit of the doubt. *Update: During a quarantine walk, I spot-checked several other sections of sidewalk in my neighborhood and found the City data fairly inaccurate - doubling the widths as above brings the data in closer approximation of the real sidewalk widths.*
